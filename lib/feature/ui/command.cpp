...
const Command Command::PARTITION_GET_FRAGMENTATION  = Command("getFragmentation #", "Get Fragmentation", "Returns the fragmentation of the specified partition");
const Command Command::PARTITION_DEFRAGMENT         = Command("defragPart #","Defragment Part.","Defragments the partition if possible");
